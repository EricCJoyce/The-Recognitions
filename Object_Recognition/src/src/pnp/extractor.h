...
class Extractor
  {
    public:
      ...
      void posMat(unsigned char, bool, cv::Mat*) const;             //  Return a matrix of all features (x, y) of given type
                                                                    //  Build an array of the indices into 'd' of all features of given type
      unsigned int indexVec(unsigned char, bool, unsigned int**) const;
      unsigned int responseVec(unsigned char, bool, float**) const; //  Build an array of response scores of all features of given type
      ...
      unsigned int revealed() const;                                //  Return the number of non-suppressed features of all types
      unsigned int revealed(unsigned char) const;                   //  Return the number of non-suppressed features of a given types
      ...
      void setNonMaxSuppression(float);
      float nonMaxSuppression() const;
      unsigned int performNonMaxSuppression(unsigned char);
      unsigned int revealAll(unsigned char);
      ...
      void setWriteDetections(bool);                                //  Toggle whether we write detected (X, Y) to text file
      ...
      void writeDetectionsToFile() const;
    ...
    private:
      ...
      bool writeDetections;                                         //  Whether to write (X, Y) detected features to text file
  };
