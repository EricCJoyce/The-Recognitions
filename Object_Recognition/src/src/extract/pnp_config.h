...
#define PARAM_RATIO_THRESH      16                                  /* Flag indicating that the ratio threshold is to follow */
#define PARAM_MAX_NN_L2_DIST    17                                  /* Flag indicating the maximum L2 distance for nearest neighbors is to follow */
#define PARAM_MAX_NN_HAMM_DIST  18                                  /* Flag indicating the maximum Hamming distance for nearest neighbors is to follow */
#define PARAM_POSE_EST_METHOD   19                                  /* Flag indicating that the argument to follow sets the pose estimation method */
#define PARAM_Q_LIMIT_FEATURES  20                                  /* Flag indicating that the argument to follow sets the number of query-features to keep */
#define PARAM_BRISK_CONFIG      21                                  /* Flag indicating that a BRISK configuration file path is to follow */
#define PARAM_ORB_CONFIG        22                                  /* Flag indicating that an ORB configuration file path is to follow */
#define PARAM_SIFT_CONFIG       23                                  /* Flag indicating that a SIFT configuration file path is to follow */
#define PARAM_SURF_CONFIG       24                                  /* Flag indicating that a SURF configuration file path is to follow */
#define PARAM_MASK              25                                  /* Flag indicating that an extractor mask file path is to follow */
...
class PnPConfig
  {
    ...
    private:
      ...
      float _ratioThreshold;                                        //  Lowe's ratio test
      ...
      bool _matchSig2Query;                                         //  Whether we "train" on the Signatures and query the image or vice versa
