...
def usage():
	...
	print(' e.g.:  python3 assemble_enactment.py -e BackBreaker1 -e Enactment1 -e Enactment2 -e Enactment3 -e Enactment4 -e Enactment5 -e Enactment6 -e Enactment9 -e Enactment10 -e MainFeederBox1 -e Regulator1 -e Regulator2 -e Enactment11 -e Enactment12 -v -color colors.txt -render -sigHand 2.0 2.0 2.0 -sigHead 4.0 3.5 6.5 -handsrc .IK-bbox.handposes')
