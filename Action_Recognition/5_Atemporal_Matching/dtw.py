...
def usage():
	...
	print(' e.g.:  python3.5 dtw.py -t BackBreaker1 -t Enactment1 -t Enactment2 -t Enactment3 -t Enactment4 -t Enactment5 -t Enactment6 -t Enactment7 -t Enactment9 -t Enactment10 -t MainFeederBox1 -t Regulator1 -t Regulator2 -v Enactment11 -v Enactment12 -split data-split-1_09sep21.txt -colors colors_gt.txt -V -render')
	print('')
