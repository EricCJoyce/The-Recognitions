...
def usage():
	...
	print('')
	print('Usage:  python3 dtw.py <parameters, preceded by flags>')
	print(' e.g.:  python3 dtw.py -d BackBreaker1 -d Enactment1 -d Enactment2 -d Enactment3 -d Enactment4 -d Enactment5 -d Enactment6 -d Enactment7 -d Enactment9 -d Enactment10 -d MainFeederBox1 -d Regulator1 -d Regulator2 -split data-split-04oct21.txt -V')
	print(' e.g.:  python3 dtw.py -t BackBreaker1 -t Enactment1 -t Enactment2 -t Enactment3 -t Enactment4 -t Enactment5 -t Enactment6 -t Enactment7 -t Enactment9 -t Enactment10 -t MainFeederBox1 -t Regulator1 -t Regulator2 -v Enactment11 -v Enactment12 -split data-split-1_09sep21.txt -colors colors_gt.txt -V -render')
	print('')
